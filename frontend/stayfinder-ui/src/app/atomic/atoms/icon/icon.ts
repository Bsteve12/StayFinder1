...
export class IconComponent {
   ...
   * size: número en px o string con clases (ej '24' o 'w-6 h-6')   * color: CSS color o clase tailwind (ej: '#1976d2' o 'text-primary')
   * spin: si aplica animación giratoria (para FontAwesome o CSS)   * faIcon: (opcional) IconDefinition si usas FontAwesome y pasas directamente la definición
   */
